...
# Add rpscrape folder to path if it exists
...
with tab3:
    ...
    if st.button("🔄 Test rpscrape Import"):
        try:
            import racecards
            st.success("✅ rpscrape imported successfully!")
    ...
    if st.button("🔄 Load Race Field"):
        st.info("Demo data loaded (rpscrape ready for future use)")
...
st.caption("KGF Handicapper v1 — Built Using Mom's Techniques and Insights 🐱💰")
